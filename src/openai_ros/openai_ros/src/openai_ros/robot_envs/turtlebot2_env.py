...
class TurtleBot2Env(robot_gazebo_env.RobotGazeboEnv):
    ...
    def __init__(self):
        ...
        * /kobuki/laser/scan: Laser Readings
        ...
        rospy.Subscriber("/laserscan", LaserScan, self._laser_scan_callback)

        self._cmd_vel_pub = rospy.Publisher('/cmd_vel_mux/input/teleop', Twist, queue_size=1)
    ...
    def _check_laser_scan_ready(self):
        ...
        while self.laser_scan is None and not rospy.is_shutdown():
            try:
                self.laser_scan = rospy.wait_for_message("/laserscan", LaserScan, timeout=5.0)
